(() => {
  ...
  function buildScreens(data) {
    ...
    const openingCopy = `On day one, everyone would have sold their mother to win just one day of this amazing game.<br>On this very last day, everyone is missing their mom and we have only one winner.<br><br>It was an incredible journey full of turns, plot twists, and revelations. The people who seemed bad actually were bad.Only the greatest made it to the top, and only the very best won.<br>Before celebrating, I'd like you to take a look at this incredible, amazing, unhealthy, sick hell we created, so we can remember what to do and what not to do on our next adventure!`;
